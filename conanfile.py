...
class ProjectAveragesPluginConan(ConanFile):
    ...
    name = "ProjectAveragesPlugin"
    description = """Plugins for displaying ProjectAverages in ManiVaultStudio."""
    topics = ("hdps", "plugin", "image data", "loading")
    url = "https://github.com/ManiVaultStudio/ProjectAveragesPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ProjectAveragesPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ProjectAveragesPlugin")
        cmake.verbose = True
        return cmake
